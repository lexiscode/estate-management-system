<div class="footer">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
                <h4>Follow us</h4>
                <a href="#"><img src={{ asset("general-users/images/facebook.png") }} alt="facebook"></a>
                <a href="#"><img src={{ asset("general-users/images/twitter.png") }} alt="twitter"></a>
                <a href="#"><img src={{ asset("general-users/images/linkedin.png") }} alt="linkedin"></a>
                <a href="#"><img src={{ asset("general-users/images/instagram.png") }} alt="instagram"></a>
            </div>
