        ...
        <div class="spacer agents">
            ...
            <div class="row">
                <div class="col-lg-8  col-lg-offset-2 col-sm-12">
                    <!-- agents -->
                    <div class="row">
                        <div class="col-lg-2 col-sm-2 "><a href="#"><img src={{ asset("users/images/agents/1.jpg") }}
                    ...
                    <!-- agents -->
                    <div class="row">
                        <div class="col-lg-2 col-sm-2 "><a href="#"><img src={{ asset("users/images/agents/2.jpg") }}
                                    class="img-responsive" alt="agent name"></a></div>
                        <div class="col-lg-7 col-sm-7 ">
                            <h4>John Smith</h4>
                            <p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically
                    ...
                    <!-- agents -->
                    <div class="row">
                        <div class="col-lg-2 col-sm-2 "><a href="#"><img src={{ asset("users/images/agents/3.jpg") }}
                                    class="img-responsive" alt="agent name"></a></div>
                        <div class="col-lg-7 col-sm-7 ">
                            <h4>John Smith</h4>
                            <p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically
                    ...
                    <!-- agents -->
                    <div class="row">
                        <div class="col-lg-2 col-sm-2 "><a href="#"><img src={{ asset("users/images/agents/4.jpg") }}
                                    class="img-responsive" alt="agent name"></a></div>
                        <div class="col-lg-7 col-sm-7 ">
                            <h4>John Smith</h4>
                            <p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically
