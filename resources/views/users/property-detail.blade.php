            ...
            <div class="row">
                <div class="col-lg-3 col-sm-4 hidden-xs">
                    ...
                    <div class="hot-properties hidden-xs">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-5"><img src={{ asset('users/images/properties/4.jpg') }}
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-5"><img src={{ asset('users/images/properties/1.jpg') }}
                                    class="img-responsive img-circle" alt="properties" /></div>
                            <div class="col-lg-8 col-sm-7">
                                <h5><a href="{{ route('view.home') }}">Integer sed porta quam</a></h5>
                                <p class="price">$300,000</p>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-5"><img src={{ asset('users/images/properties/3.jpg') }}
                                    class="img-responsive img-circle" alt="properties" /></div>
                            <div class="col-lg-8 col-sm-7">
                                <h5><a href="{{ route('view.home') }}">Integer sed porta quam</a></h5>
                                <p class="price">$300,000</p>
                            ...
                            <div class="col-lg-12  col-sm-6">
                                ...
                                <div class="listing-detail">
                                    <span data-toggle="tooltip" data-placement="bottom"
                                        ...
                                        data-placement="bottom" data-original-title="Kitchen">1</span>
                                </div>
