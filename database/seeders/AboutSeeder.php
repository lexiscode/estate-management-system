...
class AboutSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $admin->background = "Lorem Ipsum is simply dummy text of the printing and typesetting industry.
        ...
        $admin->profile = "Contrary to popular belief, Lorem Ipsum is not simply random text. It has
